...
// --- 1. CONFIGURAÇÃO DE MIDDLEWARES GERAIS ---
...
const publicPages = {
    ...
    '/noticias': 'paginas/noticias.html', '/artigos': 'paginas/sistema/artigos.html', '/contato': 'paginas/contato.html',
...
// --- 5. ROTAS DE API PÚBLICAS (NÃO EXIGEM TOKEN) ---
const publicApiRouter = express.Router();

// Rota pública para listar os últimos artigos
publicApiRouter.get('/home/artigos', async (req, res) => {
    try {
...
// Rota pública para buscar um artigo específico pelo ID
publicApiRouter.get('/artigos/:id', async (req, res) => {
    try {
...
// Rota pública para notícias
publicApiRouter.get('/home/noticias', async (req, res) => {
    const noticias = await buscarNoticias();
    res.json(noticias);
});

// Registra o roteador público
app.use('/', publicApiRouter);


// --- 6. ROTAS DE API PROTEGIDAS (EXIGEM TOKEN) ---
const apiRouter = express.Router();
apiRouter.use(checkToken); // Aplica o middleware de autenticação em todas as rotas deste router
...
// Registra o roteador protegido com o prefixo /api
app.use('/api', apiRouter);


// --- 7. CONEXÃO COM O BANCO DE DADOS E INICIALIZAÇÃO DO SERVIDOR ---
